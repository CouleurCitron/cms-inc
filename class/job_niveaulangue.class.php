...
/* [Begin patch] */
/* [End patch] */
if(file_exists($_SERVER['DOCUMENT_ROOT'].'/include/bo/class/job_niveaulangue.class.php')  && (strpos(__FILE__,'/include/bo/class/job_niveaulangue.class.php')===FALSE) ){
		include_once($_SERVER['DOCUMENT_ROOT'].'/include/bo/class/job_niveaulangue.class.php');
}else{
/*======================================

objet de BDD job_niveaulangue :: class job_niveaulangue

SQL mySQL:

DROP TABLE IF EXISTS job_niveaulangue;
CREATE TABLE job_niveaulangue
(
...
<class name="job_niveaulangue" prefix="job" display="libelle" abstract="libelle">
<item name="id" type="int" length="11" isprimary="true" notnull="true" default="-1" list="true" />
<item name="libelle" libelle="Libellé" type="int" length="11" list="true" order="true" translate="reference" /> 
<item name="ordre" libelle="Ordre" type="int" length="11" list="true" order="false" default="0"/>
...
var $sMySql = "CREATE TABLE job_niveaulangue
(
	job_id			int (11) PRIMARY KEY not null,
	job_libelle			int (11),
	job_ordre			int (11),
...
// constructeur
function job_niveaulangue($id=null)
{
...
//
function getTable() { return("job_niveaulangue"); }
function getClasse() { return("job_niveaulangue"); }
