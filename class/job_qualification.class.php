...
/* [Begin patch] */
/* [End patch] */
if(file_exists($_SERVER['DOCUMENT_ROOT'].'/include/bo/class/job_qualification.class.php')  && (strpos(__FILE__,'/include/bo/class/job_qualification.class.php')===FALSE) ){
		include_once($_SERVER['DOCUMENT_ROOT'].'/include/bo/class/job_qualification.class.php');
}else{
/*======================================

objet de BDD job_qualification :: class job_qualification
...
<class name="job_qualification" libelle="Niveau de qualification" prefix="job" display="libelle" abstract="">
...
var $sMySql = "CREATE TABLE job_qualification
(
	job_id			int (11) PRIMARY KEY not null,
	job_libelle			int (11),
	job_ordre			int (11),
...
// constructeur
function job_qualification($id=null)
{
...
//
function getTable() { return("job_qualification"); }
function getClasse() { return("job_qualification"); }
