...
/* [Begin patch] */
/* [End patch] */
if(file_exists($_SERVER['DOCUMENT_ROOT'].'/include/bo/class/job_contrat.class.php')  && (strpos(__FILE__,'/include/bo/class/job_contrat.class.php')===FALSE) ){
		include_once($_SERVER['DOCUMENT_ROOT'].'/include/bo/class/job_contrat.class.php');
}else{
/*======================================

objet de BDD job_contrat :: class job_contrat
...
<class name="job_contrat" prefix="job" display="libelle" abstract="libelle">
...
var $sMySql = "CREATE TABLE job_contrat
(
	job_id			int (11) PRIMARY KEY not null,
	job_libelle			int (11),
	job_ordre			int (11),
...
//
function getTable() { return("job_contrat"); }
function getClasse() { return("job_contrat"); }
