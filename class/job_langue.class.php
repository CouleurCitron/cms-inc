...
<class name="job_langue" libelle="Langues parlées" prefix="job" display="libelle" abstract="">
<item name="id" type="int" length="11" isprimary="true" notnull="true" default="-1" list="true" />
<item name="libelle" libelle="Libellé" type="int" length="11" list="true" order="false" translate="reference" /> 
