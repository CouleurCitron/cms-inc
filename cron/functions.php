...
function get_date_syntaxe_ymdhis ($mydate) { 
	...
	if (ereg("([0-9]{4})-[0-9]{2}-[0-9]{2} [0-9]{2}:[0-9]{2}:[0-9]{2}", $mydate)){	
		$aaaa = ereg_replace("([0-9]{4})-[0-9]{2}-[0-9]{2} [0-9]{2}:[0-9]{2}:[0-9]{2}", "\\1", $mydate);	
		$mm = ereg_replace("[0-9]{4}-([0-9]{2})-[0-9]{2} [0-9]{2}:[0-9]{2}:[0-9]{2}", "\\1", $mydate);
		$jj = ereg_replace("[0-9]{4}-[0-9]{2}-([0-9]{2}) [0-9]{2}:[0-9]{2}:[0-9]{2}", "\\1", $mydate);	
		
		$hh = ereg_replace("[0-9]{4}-[0-9]{2}-[0-9]{2} ([0-9]{2}):[0-9]{2}:[0-9]{2}", "\\1", $mydate);
		$min = ereg_replace("[0-9]{4}-[0-9]{2}-[0-9]{2} [0-9]{2}:([0-9]{2}):[0-9]{2}", "\\1", $mydate);
		$ss = ereg_replace("[0-9]{4}-[0-9]{2}-[0-9]{2} [0-9]{2}:[0-9]{2}:([0-9]{2})", "\\1", $mydate);					
	
	} 
	else if (ereg("([0-9]{2})/[0-9]{2}/[0-9]{4} [0-9]{2}:[0-9]{2}:[0-9]{2}", $mydate)){	
		$aaaa = ereg_replace("[0-9]{2}/[0-9]{2}/([0-9]{4}) [0-9]{2}:[0-9]{2}:[0-9]{2}", "\\1", $mydate);	
		$mm = ereg_replace("[0-9]{2}/([0-9]{2})/[0-9]{4} [0-9]{2}:[0-9]{2}:[0-9]{2}", "\\1", $mydate);
		$jj = ereg_replace("([0-9]{2})/[0-9]{2}/[0-9]{4} [0-9]{2}:[0-9]{2}:[0-9]{2}", "\\1", $mydate);	
		
		$hh = ereg_replace("[0-9]{2}/[0-9]{2}/[0-9]{4} ([0-9]{2}):[0-9]{2}:[0-9]{2}", "\\1", $mydate);
		$min = ereg_replace("[0-9]{2}/[0-9]{2}/[0-9]{4} [0-9]{2}:([0-9]{2}):[0-9]{2}", "\\1", $mydate);
		$ss = ereg_replace("[0-9]{2}/[0-9]{2}/[0-9]{4} [0-9]{2}:[0-9]{2}:([0-9]{2})", "\\1", $mydate);					
