...
// +----------------------------------------------------------------------+
//
// $Id: Common.php,v 1.1 2013-09-30 09:46:12 raphael Exp $

require_once 'cms-inc/lib/pear/PEAR.php';
require_once 'cms-inc/lib/pear/Archive/Tar.php';
require_once 'cms-inc/lib/pear/System.php';
require_once 'cms-inc/lib/pear/PEAR/Config.php';
            ...
            case 'name':
                switch ($this->prev_element) {
                    case 'package':
                        ...
                        $this->pkginfo['package'] = preg_replace('/[^a-zA-Z0-9._]/msi', '_', $data);
                        break;
                    case 'maintainer':
