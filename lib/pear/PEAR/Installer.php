...
// +----------------------------------------------------------------------+
//
// $Id: Installer.php,v 1.1 2013-09-30 09:46:14 raphael Exp $

require_once 'cms-inc/lib/pear/PEAR/Common.php';
require_once 'cms-inc/lib/pear/PEAR/Registry.php';
require_once 'cms-inc/lib/pear/PEAR/Dependency.php';
...
class PEAR_Installer extends PEAR_Common
{
    ...
    function install($pkgfile, $options = array())
    {
        ...
        if (empty($options['register-only'])) {
            ...
            $pkgname    = preg_replace ('/[^a-zA-Z0-9._]/msi', '_', $pkginfo['package']);
            $pkgversion = preg_replace ('/[^a-zA-Z0-9._\-]/msi', '_', $pkginfo['version']);
