...
// sponthus 30/08/2005 
	...
	// new thao 30/08/2011
	var $showResults = true; // affiches le nombre de résultats par défauts
	var $showFooter = true; // affiche la page courante
	var $separator = '&nbsp;'; // affiche un séparateur 
...
// execution de la requete une deuxième fois pour replacer le curseur en haut...
		if ($this->db->pageExecuteCountRows) $ADODB_COUNTRECS = true;
